/* eslint-disable */
import type { Prisma, Product } from "@prisma-app/client";
...
export function useCreateProduct(options?: Omit<(MutationOptions<(Product | undefined), DefaultError, Prisma.ProductCreateArgs> & ExtraMutationOptions), 'mutationFn'>) {
    ...
    const mutation = derived(_mutation, value => ({
        ...
        mutateAsync: async <T extends Prisma.ProductCreateArgs>(
            ...
            options?: Omit<(MutationOptions<(CheckSelect<T, Product, Prisma.ProductGetPayload<T>> | undefined), DefaultError, Prisma.SelectSubset<T, Prisma.ProductCreateArgs>> & ExtraMutationOptions), 'mutationFn'>
        ) => {
...
export function useCreateManyProduct(options?: Omit<(MutationOptions<Prisma.BatchPayload, DefaultError, Prisma.ProductCreateManyArgs> & ExtraMutationOptions), 'mutationFn'>) {
    const { endpoint, fetch } = getHooksContext();
    const _mutation =
    ...
    const mutation = derived(_mutation, value => ({
        ...
        mutateAsync: async <T extends Prisma.ProductCreateManyArgs>(
            ...
            options?: Omit<(MutationOptions<Prisma.BatchPayload, DefaultError, Prisma.SelectSubset<T, Prisma.ProductCreateManyArgs>> & ExtraMutationOptions), 'mutationFn'>
        ) => {
            return (await value.mutateAsync(
                args,
                options as any
...
export function useFindManyProduct<TArgs extends Prisma.ProductFindManyArgs, TQueryFnData = Array<Prisma.ProductGetPayload<TArgs> & { $optimistic?: boolean }>, TData = TQueryFnData, TError = DefaultError>(args?: Prisma.SelectSubset<TArgs, Prisma.ProductFindManyArgs>, options?: (StoreOrVal<Omit<CreateQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
    return useModelQuery<TQueryFnData, TData, TError>('Product', `${endpoint}/product/findMany`, args, options, fetch);
}

export function useInfiniteFindManyProduct<TArgs extends Prisma.ProductFindManyArgs, TQueryFnData = Array<Prisma.ProductGetPayload<TArgs>>, TData = TQueryFnData, TError = DefaultError>(args?: Prisma.SelectSubset<TArgs, Prisma.ProductFindManyArgs>, options?: StoreOrVal<Omit<CreateInfiniteQueryOptions<TQueryFnData, TError, InfiniteData<TData>>, 'queryKey'>>) {
...
export function useFindUniqueProduct<TArgs extends Prisma.ProductFindUniqueArgs, TQueryFnData = Prisma.ProductGetPayload<TArgs> & { $optimistic?: boolean }, TData = TQueryFnData, TError = DefaultError>(args: Prisma.SelectSubset<TArgs, Prisma.ProductFindUniqueArgs>, options?: (StoreOrVal<Omit<CreateQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
...
export function useUpdateProduct(options?: Omit<(MutationOptions<(Product | undefined), DefaultError, Prisma.ProductUpdateArgs> & ExtraMutationOptions), 'mutationFn'>) {
    const { endpoint, fetch } = getHooksContext();
    const _mutation =
    ...
    const mutation = derived(_mutation, value => ({
        ...
        mutateAsync: async <T extends Prisma.ProductUpdateArgs>(
            ...
            options?: Omit<(MutationOptions<(CheckSelect<T, Product, Prisma.ProductGetPayload<T>> | undefined), DefaultError, Prisma.SelectSubset<T, Prisma.ProductUpdateArgs>> & ExtraMutationOptions), 'mutationFn'>
        ) => {
            return (await value.mutateAsync(
                args,
                options as any
...
export function useUpdateManyProduct(options?: Omit<(MutationOptions<Prisma.BatchPayload, DefaultError, Prisma.ProductUpdateManyArgs> & ExtraMutationOptions), 'mutationFn'>) {
    const { endpoint, fetch } = getHooksContext();
    const _mutation =
    ...
    const mutation = derived(_mutation, value => ({
        ...
        mutateAsync: async <T extends Prisma.ProductUpdateManyArgs>(
            ...
            options?: Omit<(MutationOptions<Prisma.BatchPayload, DefaultError, Prisma.SelectSubset<T, Prisma.ProductUpdateManyArgs>> & ExtraMutationOptions), 'mutationFn'>
        ) => {
            return (await value.mutateAsync(
                args,
                options as any
...
export function useUpsertProduct(options?: Omit<(MutationOptions<(Product | undefined), DefaultError, Prisma.ProductUpsertArgs> & ExtraMutationOptions), 'mutationFn'>) {
    const { endpoint, fetch } = getHooksContext();
    const _mutation =
    ...
    const mutation = derived(_mutation, value => ({
        ...
        mutateAsync: async <T extends Prisma.ProductUpsertArgs>(
            ...
            options?: Omit<(MutationOptions<(CheckSelect<T, Product, Prisma.ProductGetPayload<T>> | undefined), DefaultError, Prisma.SelectSubset<T, Prisma.ProductUpsertArgs>> & ExtraMutationOptions), 'mutationFn'>
        ) => {
            return (await value.mutateAsync(
                args,
                options as any
...
export function useDeleteProduct(options?: Omit<(MutationOptions<(Product | undefined), DefaultError, Prisma.ProductDeleteArgs> & ExtraMutationOptions), 'mutationFn'>) {
    const { endpoint, fetch } = getHooksContext();
    const _mutation =
    ...
    const mutation = derived(_mutation, value => ({
        ...
        mutateAsync: async <T extends Prisma.ProductDeleteArgs>(
            ...
            options?: Omit<(MutationOptions<(CheckSelect<T, Product, Prisma.ProductGetPayload<T>> | undefined), DefaultError, Prisma.SelectSubset<T, Prisma.ProductDeleteArgs>> & ExtraMutationOptions), 'mutationFn'>
        ) => {
            return (await value.mutateAsync(
                args,
                options as any
...
export function useDeleteManyProduct(options?: Omit<(MutationOptions<Prisma.BatchPayload, DefaultError, Prisma.ProductDeleteManyArgs> & ExtraMutationOptions), 'mutationFn'>) {
    const { endpoint, fetch } = getHooksContext();
    const _mutation =
    ...
    const mutation = derived(_mutation, value => ({
        ...
        mutateAsync: async <T extends Prisma.ProductDeleteManyArgs>(
            ...
            options?: Omit<(MutationOptions<Prisma.BatchPayload, DefaultError, Prisma.SelectSubset<T, Prisma.ProductDeleteManyArgs>> & ExtraMutationOptions), 'mutationFn'>
        ) => {
            return (await value.mutateAsync(
                args,
                options as any
...
export function useAggregateProduct<TArgs extends Prisma.ProductAggregateArgs, TQueryFnData = Prisma.GetProductAggregateType<TArgs>, TData = TQueryFnData, TError = DefaultError>(args: Prisma.SelectSubset<TArgs, Prisma.ProductAggregateArgs>, options?: (StoreOrVal<Omit<CreateQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
...
export function useGroupByProduct<TArgs extends Prisma.ProductGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<TArgs>>, Prisma.Extends<'take', Prisma.Keys<TArgs>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? { orderBy: Prisma.ProductGroupByArgs['orderBy'] } : { orderBy?: Prisma.ProductGroupByArgs['orderBy'] }, OrderFields extends Prisma.ExcludeUnderscoreKeys<Prisma.Keys<Prisma.MaybeTupleToUnion<TArgs['orderBy']>>>, ByFields extends Prisma.MaybeTupleToUnion<TArgs['by']>, ByValid extends Prisma.Has<ByFields, OrderFields>, HavingFields extends Prisma.GetHavingFields<TArgs['having']>, HavingValid extends Prisma.Has<ByFields, HavingFields>, ByEmpty extends TArgs['by'] extends never[] ? Prisma.True : Prisma.False, InputErrors extends ByEmpty extends Prisma.True
    ...
    > : InputErrors, TData = TQueryFnData, TError = DefaultError>(args: Prisma.SelectSubset<TArgs, Prisma.SubsetIntersection<TArgs, Prisma.ProductGroupByArgs, OrderByArg> & InputErrors>, options?: (StoreOrVal<Omit<CreateQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
    return useModelQuery<TQueryFnData, TData, TError>('Product', `${endpoint}/product/groupBy`, args, options, fetch);
}

export function useCountProduct<TArgs extends Prisma.ProductCountArgs, TQueryFnData = TArgs extends { select: any; } ? TArgs['select'] extends true ? number : Prisma.GetScalarType<TArgs['select'], Prisma.ProductCountAggregateOutputType> : number, TData = TQueryFnData, TError = DefaultError>(args?: Prisma.SelectSubset<TArgs, Prisma.ProductCountArgs>, options?: (StoreOrVal<Omit<CreateQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
