...
type SchemaType = z.ZodType<Prisma.OrderItemUpdateWithoutOrderInput>;
export const OrderItemUpdateWithoutOrderInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(), product: z.lazy(() => ProductUpdateOneRequiredWithoutOrderItemsNestedInputObjectSchema).optional()
