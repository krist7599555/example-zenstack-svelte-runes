...
type SchemaType = z.ZodType<Prisma.OrderItemUncheckedUpdateManyWithoutOrderInput>;
export const OrderItemUncheckedUpdateManyWithoutOrderInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
