...
type SchemaType = z.ZodType<Prisma.OrderUncheckedUpdateWithoutItemsInput>;
export const OrderUncheckedUpdateWithoutItemsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
