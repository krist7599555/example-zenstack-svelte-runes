...
type SchemaType = z.ZodType<Prisma.OrderItemUncheckedUpdateWithoutOrderInput>;
export const OrderItemUncheckedUpdateWithoutOrderInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
