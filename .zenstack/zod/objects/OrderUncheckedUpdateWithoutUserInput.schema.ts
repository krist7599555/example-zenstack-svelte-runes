...
type SchemaType = z.ZodType<Prisma.OrderUncheckedUpdateWithoutUserInput>;
export const OrderUncheckedUpdateWithoutUserInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
